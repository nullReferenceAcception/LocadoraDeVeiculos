    ...
    public partial class TabelaLocacaoControl : UserControl
    {
        ...
        public void AtualizarRegistros(List<Locacao> locacoes)
        {
            ...
            foreach (Locacao locacao in locacoes)
                grid.Rows.Add(locacao.Id, locacao.Funcionario.Nome, locacao.Cliente.Nome,  locacao.Condutor.Nome, locacao.Veiculo.Modelo, locacao.PlanoCobranca.Nome, locacao.DataLocacao, locacao.DataDevolucaoPrevista, locacao.Status);
        }
    }
}
