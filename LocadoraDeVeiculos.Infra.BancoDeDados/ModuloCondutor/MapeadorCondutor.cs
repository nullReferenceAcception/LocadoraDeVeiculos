...
namespace LocadoraDeVeiculos.Infra.BancoDeDados.ModuloCondutor
{
    public class MapeadorCondutor : IMapeavel<Condutor>
    {
        ...
        {
            cmdInserir.Parameters.AddWithValue("GUID_CONDUTOR", registro.Id);
            ...
            cmdInserir.Parameters.AddWithValue("CLIENTE_GUID", registro.Cliente.Id);
